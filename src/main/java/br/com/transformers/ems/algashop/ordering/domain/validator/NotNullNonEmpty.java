...
@Constraint(validatedBy = NotNullNonEmptyValidator.class) // Link to the validator class
public @interface NotNullNonEmpty {
    String message() default "Null or empty"; // Default error message
